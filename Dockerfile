...
ADD django_entrypoint.sh /code/payment_service/django_entrypoint.sh

RUN chmod a+x /code/payment_service/django_entrypoint.sh

ENTRYPOINT ["/code/payment_service/django_entrypoint.sh"]
